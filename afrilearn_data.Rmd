...
`afrilearndata` library has data that can be used to learn Spatial Analysis in `R` within the African context. Having vector (with attribute data) and raster (with pixel values), the possibilities of analytic approaches are unlimited. I will barely glimpse tip of the iceberg.
...
mf_layout(title = 'African countries with ove 100 people per km2 in 2020',
          credits = paste0('Sources: Andy South, 2021\nAuthor: Wyclife Agumba Oluoch\n', 'Package: mapsf ',
                           packageVersion('mapsf'), '\nPackage: afrilearndata ',
                           packageVersion('afrilearndata')))
