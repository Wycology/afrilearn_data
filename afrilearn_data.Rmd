...
`afrilearndata` package has data that can be used to learn Spatial Analysis in `R` within the African context. Having vector (with attribute data) and raster (with pixel values), the possibilities of analytic approaches are unlimited. I will barely glimpse tip of the iceberg.
...
## Mapping of opulation field as proprotional circles
...
## Mappinopulation in choropleth protocol
...
Here I map only countries whose population density values by 2020 fall below 20 people per square km.
