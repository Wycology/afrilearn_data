...
`afrilearndata` library has usdata that can be used to learn Spatial Analysis in `R` within the African context. Having vector (with attribute data) and raster (with pixel values), the possibilities of analytic approaches are unlimited. I will barely glimpse tip of the iceberg.
