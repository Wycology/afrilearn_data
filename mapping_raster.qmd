...
When you click the **Render** button, a document will be generated that includes both content and the output of embedded code. Alternative ou can also just click _Ctrl+Shift+K_.
